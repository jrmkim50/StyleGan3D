...
if 1:
    ...
    mixing        = EasyDict(run_func_name='training.training_loop.mixing')
    test_d        = EasyDict(run_func_name='training.training_loop.test_d')
    ...
    # Number of GPUs.
    desc += '-1gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 128, 64: 64, 128: 32, 256: 16}
    # desc += '-2gpu'; submit_config.num_gpus = 2; sched.minibatch_base = 8; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8}
    # desc += '-4gpu'; submit_config.num_gpus = 4; sched.minibatch_base = 16; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16}
    # desc += '-8gpu'; submit_config.num_gpus = 8; sched.minibatch_base = 32; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 128, 64: 64, 128: 32, 256: 16}

    # Default options.
    train.total_kimg = 25000
    sched.lod_initial_resolution = 4
    sched.G_lrate_dict = {128: 0.005, 256: 0.002, 512: 0.003, 1024: 0.003}
    sched.D_lrate_dict = {128: 0.002, 256: 0.002, 512: 0.003, 1024: 0.003}

    # train.resume_run_id=51
    # train.test=True
    # train.is_training=False
    # train.resume_snapshot=10360
    # train.resume_kimg=6060

    # test_d.resume_run_id=46

    # mixing.resume_run_id=29
